...
public class TakeRideAirPlaneDelegateBaseTwoRide extends TakeRideViewDelegateBase{


    public final static int TAKE_RIDE_AIRPORT_DEPARTURE = 0;
    public final static int TAKE_RIDE_AIRPORT_DESTINATION = 1;
    ...
    public TakeRideAirPlaneDelegateBaseTwoRide(TakeRideMenuActivity clientTakeRideActivity, Constants.APP_REGISTER_DRIVER_TYPE _dataType, Constants.APP_REGISTER_ORDER_TYPE _orderCargoType, String _currAddress, ViewPager _mPager) {
    ...
    public void setInitialActivity(){
        clientTakeRideActivity.setTitle(R.string.client_airplane_pick_up);
        ridePage = new ArrayList<>();
        ridePage.add(new RideType(clientTakeRideActivity.getString(R.string.tab_send_airport), TAKE_RIDE_AIRPORT_DEPARTURE,dataType.value(),orderCargoType.value(),currAddress));
        ridePage.add(new RideType(clientTakeRideActivity.getString(R.string.tab_pick_up_airport), TAKE_RIDE_AIRPORT_DESTINATION,dataType.value(),orderCargoType.value(),currAddress));
